    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        if ((boolean) fromServer1 == true) {
            ...
            while (true) {
                ...
                System.out.println("1. Press b to check balance");
                System.out.println("2. Press c to Credit balance");
                System.out.println("3. Press d to Debit balance");
                System.out.println("4. Press q to Log Out\n");
